...
class SpecialDocumentFormatter extends \SpecialPage {
    ...
    public static function processInput( $formData, $out) {
        ...
        #"cd /var/www/vhosts/wiki.ontracknorthamerica.org/httpdocs/extensions/DocumentFormatter/resources/python && pwb login && pwb variables.py $page $filedir $filetype";
